...
KEY="6330242542:AAE6c2PWi3Zy81zns2SX_upV0YUlkQ6Wq_Q"
URL="https://api.telegram.org/bot$KEY/sendMessage"
REPO="https://raw.githubusercontent.com/MAPTECH-GH/VVV/main/"
...
function pasang_ssl() {
    ...
    curl https://raw.githubusercontent.com/MAPTECH-GH/VVV/main/acme.sh -o /root/.acme.sh/acme.sh
...
function install_xray(){
    ...
    xraycore_link="https://github.com/MAPTECH-GH/Xcore-custompath/releases/download/Xray-linux-64-v1.6.5.1/Xray-linux-64-v1.6.5.1"
